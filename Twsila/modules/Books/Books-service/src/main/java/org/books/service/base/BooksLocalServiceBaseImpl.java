...
import org.books.service.BooksLocalService;
import org.books.service.BooksLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.books.service.impl.BooksLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see org.books.service.impl.BooksLocalServiceImpl
 * @generated
 */
public abstract class BooksLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BooksLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BooksLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(booksLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		BooksLocalService booksLocalService) {

		try {
			Field field = BooksLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, booksLocalService);
		}
